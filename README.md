...
| **Source Code Archive** | `MDPlus-1.14.2-src.zip` | **650 KB** | Full source code archive for offline builds and audits (also available as `MDPlus-1.1-src.zip`). | [⬇️ **Download Source**](https://github.com/nickf-sudomania/mdplusplus/raw/main/releases/MDPlus-1.14.2-src.zip) | [`releases/MDPlus-1.14.2-src.zip`](releases/MDPlus-1.14.2-src.zip) |
...
- [`MDPlus.1.14.2.checksums.sha256`](releases/MDPlus.1.14.2.checksums.sha256) — Notepad++ compatible checksum manifest (also mirrored as [`MDPlus.1.14.checksums.sha256`](releases/MDPlus.1.14.checksums.sha256) and [`MDPlus.1.13.checksums.sha256`](releases/MDPlus.1.13.checksums.sha256)).
...
- `MDPlus-1.14.2-src.zip.sha256` — Source distribution archive SHA-256 digest (and `MDPlus-1.14-src.zip.sha256`).
...
Get-FileHash dist\MDPlus-1.14.2-src.zip -Algorithm SHA256
```
...
certutil -hashfile dist\MDPlus-1.14.2-src.zip SHA256
```
...
│   ├── MDPlus-1.14.2-src.zip       # Full source distribution archive (and MDPlus-1.14-src.zip)
