# MDPlus v1.03 Release Notes

> **Release Date:** September 10, 2026  
> **Tag:** `v1.03`  
> **Target Framework:** .NET 8.0 Windows Desktop (WPF)  

MDPlus v1.03 introduces modular rendering plugins for inline & display LaTeX math formulas and raw HTML markup tags, accompanied by a comprehensive performance assessment answering: *"Will adding LaTeX and HTML rendering make this app significantly slower?"* (Empirical answer: **No**, with zero startup impact, sub-millisecond AST parsing, and zero WebBrowser/WebView2 overhead).

---

## 🚀 Key Feature Highlights

### 1. Vector LaTeX Math Rendering Plugin
...
- [**`MDPlus-Setup.exe`**](https://github.com/nickf-sudomania/mdplusplus/releases/download/v1.03/MDPlus-Setup.exe) — Windows Setup Installer with .NET 8 Bootstrapper
- [**`MDPlus.exe`**](https://github.com/nickf-sudomania/mdplusplus/releases/download/v1.03/MDPlus.exe) — Standalone Portable Single-File Binary
- [**`MDPlus-win-x64.zip`**](https://github.com/nickf-sudomania/mdplusplus/releases/download/v1.03/MDPlus-win-x64.zip) — Portable Zip Distribution
- [**`MDPlus-1.03-src.zip`**](https://github.com/nickf-sudomania/mdplusplus/releases/download/v1.03/MDPlus-1.03-src.zip) — Source Code Archive
- [**`SHA256SUMS.txt`**](https://github.com/nickf-sudomania/mdplusplus/releases/download/v1.03/SHA256SUMS.txt) — Master Cryptographic Checksum Manifest
