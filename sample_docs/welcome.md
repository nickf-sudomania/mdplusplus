...
## 📊 Multi-Format Support: Plain Text, CSV/TSV Tables & JSON (v1.12)

MDPlus v1.12 extends beyond Markdown into an ultra-fast universal notepad and structured data viewer:
